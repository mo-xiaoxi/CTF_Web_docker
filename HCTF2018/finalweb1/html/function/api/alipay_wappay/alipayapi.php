...
if($alipay == 'fk'){
	...
	//商品展示地址
	$alipay_url = 'http://'.$web['weburl'].$emmm['webpath'].'client/wap/?cn-usercenter.html';
	...
	//商品展示地址
	$alipay_url = 'http://'.$web['weburl'].$emmm['webpath'].'client/wap/?cn-userpay.html';
...
/**************************请求参数**************************/
        ...
        $payment_type = "1";
        $notify_url = 'http://'.$web['weburl'].$emmm['webpath'].'function/api/alipay_wappay/notify_url.php';
        $return_url = 'http://'.$web['weburl'].$emmm['webpath'].'function/api/alipay_wappay/return_url.php';
