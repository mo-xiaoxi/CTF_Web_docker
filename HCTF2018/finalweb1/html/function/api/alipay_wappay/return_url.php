...
if($verify_result) {
	...
	if($query){
		...
		echo '<meta http-equiv="Refresh" content="0;URL='.$emmm['webpath'].'client/wap/?cn-usercenter.html" />';
	}else{
		...
		if($emmmpay[0] == 'fk'){
			...
			echo "付款成功，3秒后跳回会员中心！";
			echo '<meta http-equiv="Refresh" content="2;URL='.$emmm['webpath'].'client/wap/?cn-usershopping-op.html" />';
			...
			//充值成功
			echo "充值成功，3秒后跳回会员中心！";
			echo '<meta http-equiv="Refresh" content="2;URL='.$emmm['webpath'].'client/wap/?cn-userpay-op.html" />';
		}
