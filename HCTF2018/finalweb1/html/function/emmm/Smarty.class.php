...
if (!isset($emmm_O0O0o00o0)){
	$smarty_error = Chr(32).Chr(45).Chr(32).Chr(80).Chr(111).Chr(119).Chr(101).Chr(114).Chr(101).Chr(100).Chr(32).Chr(98).Chr(121).Chr(32).Chr(111).Chr(117).Chr(114).Chr(112).Chr(104).Chr(112);
}
...
function smartyerror($tpl_source, Smarty_Internal_Template $template){
	global $smarty_error;
	return str_ireplace('<'.'/'.'ti'.'tl'.'e>',$smarty_error.'</'.'ti'.'tl'.'e>',$tpl_source);
}
