<?php /* Smarty version Smarty-3.1.18, created on 2018-12-14 18:33:35
         compiled from "templates\default\cn\cn_article.html" */ ?>
<?php /*%%SmartyHeaderCode:17507854155c1386ff1829c4-48538135%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6cb458afdaf7da1733a5427ed4adbc0eb76f5e2f' => 
    array (
      0 => 'templates\\default\\cn\\cn_article.html',
      1 => 1544771341,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17507854155c1386ff1829c4-48538135',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c1386ff982538_62401870',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c1386ff982538_62401870')) {function content_5c1386ff982538_62401870($_smarty_tpl) {?><?php if (!is_callable('smarty_block_callcolumn')) include './function/class\\block.callcolumn.php';
...
<?php $_smarty_tpl->smarty->_tag_stack[] = array('callcolumn', array('id'=>"2",'row'=>"10",'lang'=>"cn",'type'=>"ty",'name'=>"callcolumn")); $_block_repeat=true; echo smarty_block_callcolumn(array('id'=>"2",'row'=>"10",'lang'=>"cn",'type'=>"ty",'name'=>"callcolumn"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_callcolumn(array('id'=>"2",'row'=>"10",'lang'=>"cn",'type'=>"ty",'name'=>"callcolumn"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
<?php } ?>
    ...
    <?php $_smarty_tpl->smarty->_tag_stack[] = array('list', array('id'=>((string)$_smarty_tpl->tpl_vars['listid']->value),'form'=>"article",'name'=>"list")); $_block_repeat=true; echo smarty_block_list(array('id'=>((string)$_smarty_tpl->tpl_vars['listid']->value),'form'=>"article",'name'=>"list"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
 
         <li><a href="<?php echo $_smarty_tpl->tpl_vars['list']->value['url'];?>
" title="<?php echo $_smarty_tpl->tpl_vars['list']->value['title'];?>
"><span class="fl"><?php echo $_smarty_tpl->tpl_vars['list']->value['title'];?>
</span><span class="fr"><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['list']->value['time'],"%Y,%m,%d");?>
</span></a></li> 
		 <?php if ($_smarty_tpl->tpl_vars['list']->value['i']%5==0) {?>
		     <div class="news_line"></div>
		 <?php }?>
    <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_list(array('id'=>((string)$_smarty_tpl->tpl_vars['listid']->value),'form'=>"article",'name'=>"list"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
