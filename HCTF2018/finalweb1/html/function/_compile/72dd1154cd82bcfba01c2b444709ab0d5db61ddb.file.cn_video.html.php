<?php /* Smarty version Smarty-3.1.18, created on 2018-12-14 18:34:29
         compiled from "templates\default\cn\cn_video.html" */ ?>
<?php /*%%SmartyHeaderCode:3782327075c138735512c90-38714920%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '72dd1154cd82bcfba01c2b444709ab0d5db61ddb' => 
    array (
      0 => 'templates\\default\\cn\\cn_video.html',
      1 => 1544771341,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3782327075c138735512c90-38714920',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c138735deb333_49062187',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c138735deb333_49062187')) {function content_5c138735deb333_49062187($_smarty_tpl) {?><?php if (!is_callable('smarty_block_callcolumn')) include './function/class\\block.callcolumn.php';
...
<div class="wrap">
  <div class="main">
    <div class="fyLeft">
      <dl class="l_pro">
  <dt><a href="#" title="公司视频">公司视频</a></dt>
 
<?php $_smarty_tpl->smarty->_tag_stack[] = array('callcolumn', array('id'=>"5",'row'=>"10",'lang'=>"cn",'type'=>"ty",'name'=>"callcolumn")); $_block_repeat=true; echo smarty_block_callcolumn(array('id'=>"5",'row'=>"10",'lang'=>"cn",'type'=>"ty",'name'=>"callcolumn"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_callcolumn(array('id'=>"5",'row'=>"10",'lang'=>"cn",'type'=>"ty",'name'=>"callcolumn"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
<?php } ?>
  ...
  <?php $_smarty_tpl->smarty->_tag_stack[] = array('list', array('id'=>((string)$_smarty_tpl->tpl_vars['listid']->value),'form'=>"video",'name'=>"opcms")); $_block_repeat=true; echo smarty_block_list(array('id'=>((string)$_smarty_tpl->tpl_vars['listid']->value),'form'=>"video",'name'=>"opcms"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
" class="proname"><?php echo $_smarty_tpl->tpl_vars['opcms']->value['title'];?>
		  ...
		  <div style="position:relative; top:-180px; left:-20px;"><a href="<?php echo $_smarty_tpl->tpl_vars['opcms']->value['url'];?>
" title="<?php echo $_smarty_tpl->tpl_vars['opcms']->value['title'];?>
"><img src="skin/play.png" width="60" /></a></div>
		  </li>	
  <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_list(array('id'=>((string)$_smarty_tpl->tpl_vars['listid']->value),'form'=>"video",'name'=>"opcms"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
