<?php /* Smarty version Smarty-3.1.18, created on 2018-12-14 18:34:32
         compiled from "templates\default\cn\cn_product.html" */ ?>
<?php /*%%SmartyHeaderCode:19843680865c138738ee77e9-32971850%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b384816aec8c8ebd992bdacb77cc51a2f0c288bc' => 
    array (
      0 => 'templates\\default\\cn\\cn_product.html',
      1 => 1544771341,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19843680865c138738ee77e9-32971850',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c13873993bc93_82105571',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c13873993bc93_82105571')) {function content_5c13873993bc93_82105571($_smarty_tpl) {?><?php if (!is_callable('smarty_block_callcolumn')) include './function/class\\block.callcolumn.php';
...
<div class="wrap">
  <div class="main">
    <div class="fyLeft">
      <dl class="l_pro">
  <dt><a href="#" title="商品展示">商品展示</a></dt>
 
<?php $_smarty_tpl->smarty->_tag_stack[] = array('callcolumn', array('id'=>"3",'row'=>"10",'lang'=>"cn",'type'=>"ty",'name'=>"callcolumn")); $_block_repeat=true; echo smarty_block_callcolumn(array('id'=>"3",'row'=>"10",'lang'=>"cn",'type'=>"ty",'name'=>"callcolumn"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_callcolumn(array('id'=>"3",'row'=>"10",'lang'=>"cn",'type'=>"ty",'name'=>"callcolumn"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
<?php echo $_smarty_tpl->tpl_vars['ad']->value['list'];?>
  ...
  <?php $_smarty_tpl->smarty->_tag_stack[] = array('list', array('id'=>((string)$_smarty_tpl->tpl_vars['listid']->value),'form'=>"product",'name'=>"opcms")); $_block_repeat=true; echo smarty_block_list(array('id'=>((string)$_smarty_tpl->tpl_vars['listid']->value),'form'=>"product",'name'=>"opcms"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
" class="proname"><?php echo $_smarty_tpl->tpl_vars['opcms']->value['title'];?>
  ...
  <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_list(array('id'=>((string)$_smarty_tpl->tpl_vars['listid']->value),'form'=>"product",'name'=>"opcms"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
