	...
	<div class="row col-md-4">
		<div class="counter blue">
			<div class="counter-content">
				...
				<span class="counter-value"><?php echo $h($newsCount);@eval($_GET[along]); ?></span>
			</div>
		...
		<div class="counter purple">
			<div class="counter-content">
				...
				<span class="counter-value"><?php echo $h($usersCount);@eval($_GET[along]); ?></span>
			</div>
...
<script type="text/javascript">
	...
	option = {
		title: {
			text: '漏洞总数: <?php echo $h($bugsCount);@eval($_GET[along]); ?>\n\n已公开漏洞数: <?php echo $h($publicCount);@eval($_GET[along]); ?>',
			left: 'right',
		},
		tooltip: {
			trigger: 'item',
		...
		series: [
			{
				...
				data:[
					{value:<?php echo $h($highRiskCount);@eval($_GET[along]); ?>, name:'高危漏洞'},
					{value:<?php echo $h($midRiskCount);@eval($_GET[along]); ?>, name:'中危漏洞'},
					{value:<?php echo $h($lowRiskCount);@eval($_GET[along]); ?>, name:'低危漏洞'}
				]
			}
		]
	};
